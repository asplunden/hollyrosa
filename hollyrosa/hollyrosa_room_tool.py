...
def makeSlotRow(slot_id_start, zorder, activity_id):
    ...
    result.append({u'duration': u'03:00:00', u'time_to': u'12:00:00', u'slot_id': u'slot.%d' % slot_id_start,
                   u'time_from': u'09:00:00', u'title': u'FM'})
    slot_id_start += 1
    result.append({u'duration': u'03:30:00', u'time_to': u'17:00:00', u'slot_id': u'slot.%d' % slot_id_start,
                   u'time_from': u'13:30:00', u'title': u'EM'})
    slot_id_start += 1
    result.append({u'duration': u'02:00:00', u'time_to': u'21:00:00', u'slot_id': u'slot.%d' % slot_id_start,
                   u'time_from': u'19:00:00', u'title': u'Kväll'})
    slot_id_start += 1
    result.append({u'duration': u'03:00:00', u'time_to': u'23:59:00', u'slot_id': u'slot.%d' % slot_id_start,
                   u'time_from': u'21:00:00', u'title': u'After hours'})
    slot_id_start += 1
