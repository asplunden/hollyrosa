...
def getActivityGroup(holly_couch, activity_group_id):
    return getCouchDBDocument(holly_couch, activity_group_id, doc_type='activity_group',
                              doc_subtype=None)  # TODO: need to clean up DB before we can check subtype
...
def createEmptyProgramBooking(valid_from='',
                              valid_to='',
                              requested_date='',
                              subtype='program'):
    return dict(type='booking', subtype=subtype, valid_from=valid_from, valid_to=valid_to,
                requested_date=requested_date, booking_day_id="", slot_id="")
