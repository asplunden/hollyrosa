...
__all__ = ["VisitingGroupProgramRequestWidget"]


#...declare your static resources here

#... JS dependencies can be listed at 'javascript' so they'll get included before
dojo_js = JSLink(link='/scripts/dojo-release-1.8.0/dojo/dojo.js', javascript=[])
my_js = JSLink(link='/scripts/visiting_group_program_request_widget.js', javascript=[dojo_js])

my_css = CSSLink(link='/css/visiting_group_program_request_widget.css')
...
class VisitingGroupProgramRequestWidget(FormField):
    ...
    def __init__(self, id=None, parent=None, children=[], **kw):
        ...
        initial state."""
        super(VisitingGroupProgramRequestWidget, self).__init__(id, parent, children, **kw)
    ...
    def update_params(self, d):
        ...
        super(VisitingGroupProgramRequestWidget, self).update_params(d)
